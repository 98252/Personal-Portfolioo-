    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none select-none" aria-hidden="true">
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(circle at 40% 40%, #c084fc 0%, #9333ea 40%, transparent 70%)',
            filter: 'blur(80px)',
          }}
        />
        {/* Orb bottom-left */}
      ...
      <div className="container-fluid relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 xl:gap-14 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 order-2 lg:order-1">
            ...
            {/* Role Tags */}
            <div className="flex flex-wrap gap-2 animate-fade-up" style={{ animationDelay: '160ms' }}>
              {['AI & NLP Solutions', 'Full-Stack Web Development', 'Python & Java', 'API Security'].map((item) => (
                <span
                  key={item}
                ...
                >
                  <span className="text-[#9333ea]"><SparkleIcon /></span>
                  {item}
                </span>
              ))}
            </div>
            ...
            {/* Bio summary */}
            <p className="text-[#4b5563] text-base sm:text-lg leading-relaxed max-w-2xl animate-fade-up" style={{ animationDelay: '240ms' }}>
              {personalInfo.summary}
            </p>

            {/* Location & Contact Meta */}
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-sm text-[#6b7280] animate-fade-up" style={{ animationDelay: '300ms' }}>
              <div className="flex items-center gap-1.5">
                <span className="text-[#9333ea]"><LocationIcon /></span>
              ...
              >
                <span className="text-[#9333ea]"><MailIcon /></span>
            ...
            {/* CTA buttons & Socials */}
            <div className="flex flex-wrap items-center gap-3 pt-2 animate-fade-up" style={{ animationDelay: '360ms' }}>
              <Button
                as="a"
                href="#projects"
                variant="primary"
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end order-1 lg:order-2 animate-fade-up" style={{ animationDelay: '200ms' }}>
            <div className="relative">
              ...
              <div className="relative w-[280px] sm:w-[330px] h-[370px] sm:h-[430px] rounded-[28px] overflow-hidden shadow-[0_20px_50px_-10px_rgb(147_51_234/0.28)] border-4 border-white bg-white">
                ...
                <div
                  ...
                  style={{
                    background: 'linear-gradient(to top, rgba(147,51,234,0.18) 0%, transparent 40%)',
                  }}
                />
              </div>

              {/* Floating Chip 1: CGPA */}
              <div className="absolute -top-3 -right-3 sm:-right-5 bg-white rounded-2xl px-4 py-2.5 shadow-[0_10px_25px_-5px_rgb(0_0_0/0.1)] border border-[#ede9f6] flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-xl bg-[#f3e8ff] text-[#9333ea] flex items-center justify-center font-bold text-xs">
                  ★
                </div>
                <div>
                  <p className="text-[11px] text-[#6b7280] font-medium leading-none">CGPA</p>
                  <p className="text-sm font-bold text-[#111827] leading-tight mt-0.5">{personalInfo.cgpa}</p>
                </div>
              </div>

              {/* Floating Chip 2: University */}
              <div className="absolute -bottom-4 -left-4 sm:-left-6 bg-white rounded-2xl px-4 py-3 shadow-[0_12px_30px_-5px_rgb(0_0_0/0.12)] border border-[#ede9f6] flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#9333ea] to-[#c084fc] flex items-center justify-center text-white font-bold text-xs shadow-sm">
                  SU
                </div>
                <div>
                  <p className="text-xs font-bold text-[#111827] leading-tight">Sharda University</p>
                  <p className="text-[11px] text-[#6b7280] leading-none mt-0.5">B.Tech CSE (2023–Present)</p>
                </div>
              </div>
            </div>
          </div>
